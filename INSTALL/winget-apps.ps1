...
winget install -e --id Yubico.Authenticator  --Source winget
winget install --id microsoft.powertoys --source winget  --Source winget
winget install -e --id JanDeDobbeleer.OhMyPosh  --Source winget
Winget install --id Mozilla.Firefox.ESR --source winget  --Source winget