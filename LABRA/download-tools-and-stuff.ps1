...
#Download files
    ...
    invoke-webrequest -uri https://download.microsoft.com/download/C/7/A/C7AAD914-A8A6-4904-88A1-29E657445D03/LAPS.x64.msi -outfile "$env:UserProfile\Downloads\LAPS.x64.msi"
